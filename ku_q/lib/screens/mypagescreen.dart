...
import 'package:ku_q/written_posts_page.dart';
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    TextButton.icon(
                                      onPressed: (){
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => WrittenPostsPage(writtenPostKeys: [],)));
                                      },
                                      icon: Icon(
                              ...
                              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    TextButton.icon(
                                      onPressed: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context) => BookmarkedPostsPage(bookmarkedPostKeys: [],)));
                                      },
                                      icon: Icon(
