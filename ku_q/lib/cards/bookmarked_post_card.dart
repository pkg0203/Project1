...
class BookmarkedPostCard extends StatefulWidget {

  dynamic docKey;

  BookmarkedPostCard({super.key, required this.docKey});

  @override
  State<BookmarkedPostCard> createState() => _BookmarkedPostCardState();
}

class _BookmarkedPostCardState extends State<BookmarkedPostCard> {
